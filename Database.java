...
public class Database extends SQLiteOpenHelper {
    ...
    public ArrayList getOrderData(String username)
    {
        ...
        {
            do{
                arr.add(c.getString(1)+"$"+c.getString(2)+"$"+c.getString(3)+"$"+c.getString(4)+"$"+c.getString(5)+"$"+c.getString(Integer.parseInt("6"))+"$"+c.getString(Integer.parseInt("7"))+"$"+c.getString(Integer.parseInt("8")));
            }while(c.moveToNext());
        }
        db.close();
        return arr;
